...
void *reminder(void *rem){ //remind function that will remind user given message after a given amount of time

	struct remind *tempArg = (struct remind *)rem;
...
int main(int argc, char *argv[]){
	...
	ret = pthread_create(&rthread[0], NULL, reminder, r);
